 ...
 *
 * This is the developer documentation of the reference client for an experimental new digital currency called PIVX (http://www.tenup.org),
...
bool AppInit(int argc, char* argv[])
{
    ...
    try {
        ...
        if (fCommandLine) {
            fprintf(stderr, "Error: There is no RPC client functionality in pivxd anymore. Use the tenup-cli utility instead.\n");
            exit(1);
        }
#ifndef WIN32
