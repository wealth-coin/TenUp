...
extern UniValue setztupseed(const UniValue& params, bool fHelp);
extern UniValue getztupseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdztup(const UniValue& params, bool fHelp);
extern UniValue dztupstate(const UniValue& params, bool fHelp);
