...
extern UniValue setzwealthseed(const UniValue& params, bool fHelp);
extern UniValue getzwealthseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzwealth(const UniValue& params, bool fHelp);
extern UniValue dzwealthstate(const UniValue& params, bool fHelp);
