...
CzWEALTHWallet* zwalletMain = NULL;
...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-tupstake=<n>", strprintf(_("Enable or disable staking functionality for WEALTH inputs (0-1, default: %u)"), 1));
    strUsage += HelpMessageOpt("-zwealthstake=<n>", strprintf(_("Enable or disable staking functionality for zWEALTH inputs (0-1, default: %u)"), 1));
    ...
    strUsage += HelpMessageOpt("-zwealthbackuppath=<dir|file>", _("Specify custom backup path to add a copy of any automatic zWEALTH backup. If set as dir, every backup generates a timestamped file. If set as file, will rewrite to that file every backup. If backuppath is set as well, 4 backups will happen"));
#endif // ENABLE_WALLET
...
// ********************************************************* Step 8: load wallet
    ...
    if (fDisableWallet) {
        ...
        zwalletMain = new CzWEALTHWallet(pwalletMain->strWalletFile);
