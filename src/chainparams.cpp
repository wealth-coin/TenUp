...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (  0, uint256("0x00000e57e786b45f062aae803d3c6760638c15da423b50fd6cc8656c1a73302e"));
...
public:
    CMainParams()
    {
        ...
        nZerocoinStartTime = 1522920605; // April 15, 2018 9:30:00 AM
...
public:
    CTestNetParams()
    {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "tenup-testnet.seed.fuzzbawls.pw"));
        //vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "tenup-testnet.seed2.fuzzbawls.pw"));
