...
QT_TRANSLATE_NOOP("tenup-core", "Acceptable ciphers (default: %s)"),
...
QT_TRANSLATE_NOOP("tenup-core", "Already have that input."),
...
QT_TRANSLATE_NOOP("tenup-core", "Can't denominate: no compatible inputs left."),
QT_TRANSLATE_NOOP("tenup-core", "Can't find random Masternode."),
QT_TRANSLATE_NOOP("tenup-core", "Can't mix while sync in progress."),
...
QT_TRANSLATE_NOOP("tenup-core", "Collateral not valid."),
...
QT_TRANSLATE_NOOP("tenup-core", "Could not parse -rpcbind value %s as network address"),
...
QT_TRANSLATE_NOOP("tenup-core", "Entries are full."),
QT_TRANSLATE_NOOP("tenup-core", "Error connecting to Masternode."),
...
QT_TRANSLATE_NOOP("tenup-core", "Error: Can't select current denominated inputs"),
...
QT_TRANSLATE_NOOP("tenup-core", "Error: You already have pending entries in the Obfuscation pool"),
...
QT_TRANSLATE_NOOP("tenup-core", "Failed to read block index"),
QT_TRANSLATE_NOOP("tenup-core", "Failed to read block"),
QT_TRANSLATE_NOOP("tenup-core", "Failed to write block index"),
QT_TRANSLATE_NOOP("tenup-core", "Fee (in PIV/kB) to add to transactions you send (default: %s)"),
QT_TRANSLATE_NOOP("tenup-core", "Finalizing transaction."),
QT_TRANSLATE_NOOP("tenup-core", "Force safe mode (default: %u)"),
QT_TRANSLATE_NOOP("tenup-core", "Found enough users, signing ( waiting %s )"),
QT_TRANSLATE_NOOP("tenup-core", "Found enough users, signing ..."),
...
QT_TRANSLATE_NOOP("tenup-core", "Incompatible mode."),
...
QT_TRANSLATE_NOOP("tenup-core", "Invalid -proxy address or hostname: '%s'"),
...
QT_TRANSLATE_NOOP("tenup-core", "Invalid script detected."),
QT_TRANSLATE_NOOP("tenup-core", "Keep at most <n> unconnectable transactions in memory (default: %u)"),
QT_TRANSLATE_NOOP("tenup-core", "Last Obfuscation was too recent."),
QT_TRANSLATE_NOOP("tenup-core", "Last successful Obfuscation action was too recent."),
...
QT_TRANSLATE_NOOP("tenup-core", "Lock is already in place."),
...
QT_TRANSLATE_NOOP("tenup-core", "Masternode queue is full."),
QT_TRANSLATE_NOOP("tenup-core", "Masternode:"),
...
QT_TRANSLATE_NOOP("tenup-core", "Missing input transaction information."),
QT_TRANSLATE_NOOP("tenup-core", "Mixing in progress..."),
QT_TRANSLATE_NOOP("tenup-core", "Need to specify a port with -whitebind: '%s'"),
QT_TRANSLATE_NOOP("tenup-core", "No Masternodes detected."),
QT_TRANSLATE_NOOP("tenup-core", "No compatible Masternode found."),
QT_TRANSLATE_NOOP("tenup-core", "No funds detected in need of denominating."),
QT_TRANSLATE_NOOP("tenup-core", "No matching denominations found for mixing."),
QT_TRANSLATE_NOOP("tenup-core", "Node relay options:"),
QT_TRANSLATE_NOOP("tenup-core", "Non-standard public key detected."),
QT_TRANSLATE_NOOP("tenup-core", "Not compatible with existing transactions."),
QT_TRANSLATE_NOOP("tenup-core", "Not enough file descriptors available."),
QT_TRANSLATE_NOOP("tenup-core", "Not in the Masternode list."),
QT_TRANSLATE_NOOP("tenup-core", "Number of automatic wallet backups (default: 10)"),
QT_TRANSLATE_NOOP("tenup-core", "Obfuscation is idle."),
QT_TRANSLATE_NOOP("tenup-core", "Obfuscation request complete:"),
QT_TRANSLATE_NOOP("tenup-core", "Obfuscation request incomplete:"),
...
QT_TRANSLATE_NOOP("tenup-core", "Percentage of automatically minted Zerocoin  (10-100, default: %u)"),
...
QT_TRANSLATE_NOOP("tenup-core", "RPC SSL options: (see the Bitcoin Wiki for SSL setup instructions)"),
QT_TRANSLATE_NOOP("tenup-core", "RPC server options:"),
QT_TRANSLATE_NOOP("tenup-core", "RPC support for HTTP persistent connections (default: %d)"),
...
QT_TRANSLATE_NOOP("tenup-core", "Recalculating coin supply may take 30-60 minutes..."),
QT_TRANSLATE_NOOP("tenup-core", "Recalculating supply statistics may take 30-60 minutes..."),
...
QT_TRANSLATE_NOOP("tenup-core", "Server certificate file (default: %s)"),
QT_TRANSLATE_NOOP("tenup-core", "Server private key (default: %s)"),
QT_TRANSLATE_NOOP("tenup-core", "Session not complete!"),
...
QT_TRANSLATE_NOOP("tenup-core", "Submitted following entries to masternode: %u / %d"),
QT_TRANSLATE_NOOP("tenup-core", "Submitted to masternode, waiting for more entries ( %u / %d ) %s"),
QT_TRANSLATE_NOOP("tenup-core", "Submitted to masternode, waiting in queue %s"),
...
QT_TRANSLATE_NOOP("tenup-core", "Transaction created successfully."),
QT_TRANSLATE_NOOP("tenup-core", "Transaction fees are too high."),
QT_TRANSLATE_NOOP("tenup-core", "Transaction not valid."),
QT_TRANSLATE_NOOP("tenup-core", "Transaction too large for fee policy"),
QT_TRANSLATE_NOOP("tenup-core", "Transaction too large"),
QT_TRANSLATE_NOOP("tenup-core", "Transmitting final transaction."),
...
QT_TRANSLATE_NOOP("tenup-core", "Unknown state: id = %u"),
QT_TRANSLATE_NOOP("tenup-core", "Upgrade wallet to latest format"),
QT_TRANSLATE_NOOP("tenup-core", "Use OpenSSL (https) for JSON-RPC connections"),
...
QT_TRANSLATE_NOOP("tenup-core", "Value more than Obfuscation pool maximum allows."),
...
QT_TRANSLATE_NOOP("tenup-core", "Will retry..."),
QT_TRANSLATE_NOOP("tenup-core", "You need to rebuild the database using -reindex to change -txindex"),
QT_TRANSLATE_NOOP("tenup-core", "Your entries added successfully."),
QT_TRANSLATE_NOOP("tenup-core", "Your transaction was accepted into the pool!"),
...
QT_TRANSLATE_NOOP("tenup-core", "failed to validate zerocoin"),
