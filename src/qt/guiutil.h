...
/** Utility functions used by the TENUP Qt UI.
 */
namespace GUIUtil
{
...
// Render TENUP addresses in monospace font
...
// Parse "tenup:" URI into recipient object, return true on successful parsing
