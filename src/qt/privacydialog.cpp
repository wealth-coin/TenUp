                                                          ...
                                                          currentBalance(-1)
{
    ...
    if(GetAdjustedTime() > GetSporkValue(SPORK_16_ZEROCOIN_MAINTENANCE_MODE)) {
        ...
        ui->pushButtonMintzPIV->setToolTip(tr("zTUP is currently disabled due to maintenance."));

        ui->pushButtonSpendzPIV->setEnabled(false);
        ui->pushButtonSpendzPIV->setToolTip(tr("zTUP is currently disabled due to maintenance."));
    }
}
