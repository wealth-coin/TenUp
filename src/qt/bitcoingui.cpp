                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("TenUp Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a TenUp address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and tenup: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zTUP"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About TenUp Core"), this);
    aboutAction->setStatusTip(tr("Show information about TenUp Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for TenUp"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your TenUp addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified TenUp addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the TenUp Core help message to get a list with possible TenUp command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("TenUp Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to TenUp network", "", count));
}
...
{
    QString strTitle = tr("TenUp Core"); // default title
