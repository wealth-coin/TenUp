...
#ifndef WEALTHSILO_ZWEALTHWALLET_H
#define WEALTHSILO_ZWEALTHWALLET_H
...
public:
    CzWEALTHWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZWEALTH(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZWEALTH(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);

private:
    uint512 GetZerocoinSeed(uint32_t n);
};

#endif //WEALTHSILO_ZWEALTHWALLET_H
