...
Run TenUp behind a Tor proxy
----------------------------------

The first step is running TenUp behind a Tor proxy. This will already make all
...
```
./tenupd -onion=127.0.0.1:9050 -onlynet=tor -listen=0 -addnode=dnetzj6l4cvo2fxy.onion:989
```

In a typical situation, this suffices to run behind a Tor proxy:
```
./tenupd -proxy=127.0.0.1:9050
```

Run a TenUp hidden server
-------------------------------
...
-externalip=X   You can tell tenup about its publicly reachable address using
                ...
                /var/lib/tor/tenup-service/hostname. Onion addresses are given
...
```
./tenupd -proxy=127.0.0.1:9050 -externalip=dnetzj6l4cvo2fxy.onion:989 -listen
```
...
```
./tenupd -onion=127.0.0.1:9050 -externalip=dnetzj6l4cvo2fxy.onion:989 -discover
```

List of known TenUp Tor relays
------------------------------------
```
