...
* Update translations (ping Fuzzbawls on Slack) see [translation_process.md](https://github.com/tenup-coin/WealthSilo/blob/master/doc/translation_process.md#synchronising-translations).
...
### Build and sign WealthSilo Core for Linux, Windows, and OS X:
    ...
    ./bin/gbuild --memory 3000 --commit tenup=v${VERSION} ../tenup/contrib/gitian-descriptors/gitian-osx.yml
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/tenup-coin/WealthSilo/releases/new) with a link to the archived release notes.
