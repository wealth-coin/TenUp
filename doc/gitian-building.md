...
Clone the git repositories for tenup and gitian and then checkout the tenup version that you want to build.
...
Follow the instructions in [doc/release-process.md](release-process.md) in the tenup repository
...
```bash
    Initialized empty Git repository in /home/debian/gitian-builder/inputs/tenup/.git/
    remote: Reusing existing pack: 35606, done.
    remote: Total 35606 (delta 0), reused 0 (delta 0)
    Receiving objects: 100% (35606/35606), 26.52 MiB | 4.28 MiB/s, done.
    Resolving deltas: 100% (25724/25724), done.
    From https://github.com/tenup-crypto/tenup
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/tenup-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/tenup-build.assert
    gpg --detach-sign ${VERSION}-osx/${SIGNER}/tenup-build.assert
```
...
[tenup/gitian.sigs](https://github.com/tenup-crypto/gitian.sigs/) repository, or if that's not possible to create a pull
request.
