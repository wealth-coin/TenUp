TenUp Core version 3.0.4 is now available from:
...
TenUp Core v3.0.4 is a mandatory update for all users. This release contains various updates/fixes pertaining to the zTUP protocol, supply tracking, block transmission and relaying, as well as usability and quality-of-life updates to the GUI.
...
- #328 `a6c18c8` [Main] TenUp not responding on user quitting app (Aaron Langford)
