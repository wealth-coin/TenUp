...
In order to support loading of multiple wallets in tenup-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is tenup.cpp.
...
Changes to tenup.cpp
----------------------
tenup.cpp is the entry point into tenup-qt, and as such, will require some minor modifications to provide hooks for
