...
In order to support loading of multiple wallets in wealthsilo-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is wealthsilo.cpp.
...
Changes to wealthsilo.cpp
----------------------
wealthsilo.cpp is the entry point into wealthsilo-qt, and as such, will require some minor modifications to provide hooks for
