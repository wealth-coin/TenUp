Contributing to WealthSilo Core
============================

The WealthSilo Core project operates an open contributor model where anyone is
...
The following applies to code changes to the WealthSilo Core project, and is not to be
confused with overall WealthSilo Network Protocol consensus changes.

Whether a pull request is merged into WealthSilo Core rests with the project merge
...
Patches that change WealthSilo consensus rules are considerably more involved than
...
Where a patch set proposes to change the WealthSilo consensus, it must have been
...
The project leader is the release manager for each WealthSilo Core release.
