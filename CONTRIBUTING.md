Contributing to TenUp Core
============================

The TenUp Core project operates an open contributor model where anyone is
...
The following applies to code changes to the TenUp Core project, and is not to be
confused with overall TenUp Network Protocol consensus changes.

Whether a pull request is merged into TenUp Core rests with the project merge
...
Patches that change TenUp consensus rules are considerably more involved than
...
Where a patch set proposes to change the TenUp consensus, it must have been
...
The project leader is the release manager for each TenUp Core release.
